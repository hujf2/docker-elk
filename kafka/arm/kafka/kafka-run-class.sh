...
#https://blog.csdn.net/hua_ed/article/details/68488642
#kafka java.rmi.server.ExportException: Port already in use
#https://www.cnblogs.com/txwsqk/p/9560746.html
#docker – 无法在openwhisk设置中列出kafka主题
#http://www.cocoachina.com/articles/41954
